  ...
  <div class="w3-container w3-content w3-padding" style="max-width:1200px">
    <div class="w3-row-padding" id="about">
      ...
      <div class="w3-quarter w3-margin-bottom">
        <div class="w3-card-4">
          <img src="image/notes.webp" alt="Notes" style="width:100%">
          <div class="w3-container">
            <h3>1st Sem</h3>
            <p class="w3-opacity">Notes by LPQ</p>
            <p>Get all the notes and other documents, related to subject inside. Click below for browse!</p>
            <a href="notes_pages/1st_sem.php"><p><button class="w3-button w3-light-grey w3-hover-orange w3-block">Get Notes</button></p></a>
          </div>
        </div>
      </div>
      ...
      <div class="w3-quarter w3-margin-bottom">
        <div class="w3-card-4">
          ...
          <div class="w3-container">
            ...
            <p class="w3-opacity">Notes by LPQ</p>
            <p>Get all the notes and other documents, related to subject inside. Click below for browse!</p>
            <a href="notes_pages/2nd_sem.php"><p><button class="w3-button w3-light-grey w3-hover-orange w3-block">Get Notes</button></p></a>
          </div>
        </div>
      </div>
      ...
      <div class="w3-quarter w3-margin-bottom">
        <div class="w3-card-4">
          ...
          <div class="w3-container">
            ...
            <p class="w3-opacity">Notes by LPQ</p>
            <p>Get all the notes and other documents, related to subject inside. Click below for browse!</p>
            <a href="notes_pages/3rd_sem.php"><p><button class="w3-button w3-light-grey w3-hover-orange w3-block">Get Notes</button></p></a>
          </div>
        </div>
      </div>
      ...
      <div class="w3-quarter w3-margin-bottom">
        <div class="w3-card-4">
          ...
          <div class="w3-container">
            ...
            <p class="w3-opacity">Notes by LPQ</p>
            <p>Get all the notes and other documents, related to subject inside. Click below for browse!</p>
            <a href="notes_pages/4th_sem.php"><p><button class="w3-button w3-light-grey w3-hover-orange w3-block">Get Notes</button></p></a>
          </div>
        </div>
      </div>
      ...
      <div class="w3-quarter w3-margin-bottom">
        <div class="w3-card-4">
          ...
          <div class="w3-container">
            ...
            <p class="w3-opacity">Notes by LPQ</p>
            <p>Get all the notes and other documents, related to subject inside. Click below for browse!</p>
            <a href="notes_pages/5th_sem.php"><p><button class="w3-button w3-light-grey w3-hover-orange w3-block">Get Notes</button></p></a>
          </div>
        </div>
      </div>
      ...
      <div class="w3-quarter w3-margin-bottom">
        <div class="w3-card-4">
          ...
          <div class="w3-container">
            ...
            <p class="w3-opacity">Notes by LPQ</p>
            <p>Get all the notes and other documents, related to subject inside. Click below for browse!</p>
            <a href="notes_pages/6th_sem.php"><p><button class="w3-button w3-light-grey w3-hover-orange w3-block">Get Notes</button></p></a>
          </div>
        </div>
      </div>
      ...
      <div class="w3-quarter w3-margin-bottom">
        <div class="w3-card-4">
          ...
          <div class="w3-container">
            ...
            <p class="w3-opacity">Notes by LPQ</p>
            <p>Get all the notes and other documents, related to subject inside. Click below for browse!</p>
            <a href="notes_pages/7th_sem.php"><p><button class="w3-button w3-light-grey w3-hover-orange w3-block">Get Notes</button></p></a>
          </div>
        </div>
      </div>
      ...
      <div class="w3-quarter w3-margin-bottom">
        <div class="w3-card-4">
          ...
          <div class="w3-container">
            ...
            <p class="w3-opacity">Notes by LPQ</p>
            <p>Get all the notes and other documents, related to subject inside. Click below for browse!</p>
            <a href="notes_pages/8th_sem.php"><p><button class="w3-button w3-light-grey w3-hover-orange w3-block">Get Notes</button></p></a>
          </div>
        </div>
      </div>
